...
#ifndef APR_MEMCACHE2_H
#define APR_MEMCACHE2_H

/**
 * @file apr_memcache2.h
...
#include "apr.h"
#ifndef APU_DECLARE
#include "third_party/aprutil/gen/arch/linux/x64/include/apu.h"
#endif
#include "apr_pools.h"
#include "apr_time.h"
...
struct apr_memcache2_server_t
{
    ...
    apr_memcache2_server_status_t status; /**< @see apr_memcache2_server_status_t */
...
*/
typedef apr_memcache2_server_t* (*apr_memcache2_server_func)(void *baton,
                                                 apr_memcache2_t *mc,
 ...
 */
APU_DECLARE(apr_uint32_t) apr_memcache2_hash(apr_memcache2_t *mc,
                                            const char *data,
                                            const apr_size_t data_len);
 ...
 */
APU_DECLARE(apr_uint32_t) apr_memcache2_hash_crc32(void *baton,
                                                  const char *data,
                                                  const apr_size_t data_len);
 ...
 */
APU_DECLARE(apr_uint32_t) apr_memcache2_hash_default(void *baton,
                                                    const char *data,
                                                    const apr_size_t data_len);
 ...
 */
APU_DECLARE(apr_memcache2_server_t *) apr_memcache2_find_server_hash(apr_memcache2_t *mc,
                                                                   const apr_uint32_t hash);

/**
 * server selection compatible with the standard Perl Client.
 */
APU_DECLARE(apr_memcache2_server_t *) apr_memcache2_find_server_hash_default(void *baton,
                                                                           apr_memcache2_t *mc,
                                                                           const apr_uint32_t hash);
 ...
 * different servers.
 */
APU_DECLARE(apr_status_t) apr_memcache2_add_server(apr_memcache2_t *mc,
                                                  apr_memcache2_server_t *server);
 ...
 */
APU_DECLARE(apr_memcache2_server_t *) apr_memcache2_find_server(apr_memcache2_t *mc,
                                                              const char *host,
                                                              apr_port_t port);
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_enable_server(apr_memcache2_t *mc,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_disable_server(apr_memcache2_t *mc,
                                                      apr_memcache2_server_t *ms);
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_server_create(apr_pool_t *p,
                                                     const char *host,
                                                     apr_port_t port,
                                                     apr_uint32_t min,
                                                     apr_uint32_t smax,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_create(apr_pool_t *p,
 ...
 * @return
 */
APU_DECLARE(apr_status_t) apr_memcache2_getp(apr_memcache2_t *mc,
                                            apr_pool_t *p,
                                            const char* key,
                                            char **baton,
                                            apr_size_t *len,
 ...
 * @return
 */
APU_DECLARE(void) apr_memcache2_add_multget_key(apr_pool_t *data_pool,
                                               const char* key,
                                               apr_hash_t **values);
 ...
 * @param values hash of apr_memcache2_value_t keyed by strings, contains the
 *        result of the multiget call.
 * @return
 */
APU_DECLARE(apr_status_t) apr_memcache2_multgetp(apr_memcache2_t *mc,
 ...
 * @param flags any flags set by the client for this key
 */
APU_DECLARE(apr_status_t) apr_memcache2_set(apr_memcache2_t *mc,
                                           const char *key,
                                           char *baton,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_add(apr_memcache2_t *mc,
                                           const char *key,
                                           char *baton,
                                           const apr_size_t data_size,
                                           apr_uint32_t timeout,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_replace(apr_memcache2_t *mc,
                                               const char *key,
                                               char *baton,
                                               const apr_size_t data_size,
                                               apr_uint32_t timeout,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_delete(apr_memcache2_t *mc,
                                              const char *key,
                                              apr_uint32_t timeout);
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_incr(apr_memcache2_t *mc,
                                            const char *key,
                                            apr_int32_t n,
                                            apr_uint32_t *nv);
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_decr(apr_memcache2_t *mc,
                                            const char *key,
                                            apr_int32_t n,
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_version(apr_memcache2_server_t *ms,
                                               apr_pool_t *p,
                                               char **baton);
 ...
 */
APU_DECLARE(apr_status_t) apr_memcache2_stats(apr_memcache2_server_t *ms,
                                             apr_pool_t *p,
