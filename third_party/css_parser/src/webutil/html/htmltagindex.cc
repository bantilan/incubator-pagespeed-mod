...
HtmlTagIndex::HtmlTagIndex()
    : case_sensitive_fixed_(false), index_max_(kHtmlTagBuiltinMax) {
...
static string CaseAwareString(bool case_sensitive, const char* tag,
                              int length) {
  CHECK_GE(length, 0);
  string str;
  if (case_sensitive) {
...
int HtmlTagIndex::AddHtmlTag(const char* tag, int length) {
  ...
  if (tag_id != kHtmlTagUnknown) return tag_id;
...
#define C8(c0, c1, c2, c3, c4, c5, c6, c7) \
  ...
  switch (length) {
    ...
    case 3: {
      switch (S3(tag) | case_mask_3_) {
        ...
        case C3('!', '-', '-'):
          ...
          if (S3(tag) == C3('!', '-', '-')) return kHtmlTagBangDashDash;
          break;
        // New tags in HTML5.
        case C3('b', 'd', 'i'):
          return kHtmlTagBdi;
    ...
    case 5: {
      switch (S5(tag) | case_mask_5_) {
        ...
        // From html 4.01 spec
        case C5('f', 'r', 'a', 'm', 'e'):
          return kHtmlTagFrame;
        case C5('i', 'n', 'p', 'u', 't'):
          return kHtmlTagInput;
        case C5('l', 'a', 'b', 'e', 'l'):
          return kHtmlTagLabel;
        case C5('p', 'a', 'r', 'a', 'm'):
          return kHtmlTagParam;
        case C5('s', 'm', 'a', 'l', 'l'):
          return kHtmlTagSmall;
        case C5('s', 't', 'y', 'l', 'e'):
          return kHtmlTagStyle;
        case C5('t', 'a', 'b', 'l', 'e'):
          return kHtmlTagTable;
        case C5('t', 'b', 'o', 'd', 'y'):
          return kHtmlTagTbody;
        case C5('t', 'f', 'o', 'o', 't'):
          return kHtmlTagTfoot;
        case C5('t', 'h', 'e', 'a', 'd'):
          return kHtmlTagThead;
        case C5('t', 'i', 't', 'l', 'e'):
          return kHtmlTagTitle;
        // Used in repository/lexer/html_lexer.cc
        case C5('b', 'l', 'i', 'n', 'k'):
          return kHtmlTagBlink;
        // Used in repository/parsers/base/handler-parser.cc
        case C5('e', 'm', 'b', 'e', 'd'):
          return kHtmlTagEmbed;
        case C5('i', 'm', 'a', 'g', 'e'):
          return kHtmlTagImage;
        // From Netscape Navigator 4.0
        case C5('l', 'a', 'y', 'e', 'r'):
          return kHtmlTagLayer;
        // New tags in HTML5.
        case C5('a', 's', 'i', 'd', 'e'):
          return kHtmlTagAside;
        case C5('a', 'u', 'd', 'i', 'o'):
          return kHtmlTagAudio;
        case C5('m', 'e', 't', 'e', 'r'):
          return kHtmlTagMeter;
        case C5('t', 'r', 'a', 'c', 'k'):
          return kHtmlTagTrack;
        case C5('v', 'i', 'd', 'e', 'o'):
          return kHtmlTagVideo;
      }
    } break;
    case 6: {
      switch (S6(tag) | case_mask_6_) {
        ...
        // From html 4.01 spec
        case C6('a', 'p', 'p', 'l', 'e', 't'):
          return kHtmlTagApplet;
        case C6('b', 'u', 't', 't', 'o', 'n'):
          return kHtmlTagButton;
        case C6('c', 'e', 'n', 't', 'e', 'r'):
          return kHtmlTagCenter;
        case C6('i', 'f', 'r', 'a', 'm', 'e'):
          return kHtmlTagIframe;
        case C6('l', 'e', 'g', 'e', 'n', 'd'):
          return kHtmlTagLegend;
        case C6('o', 'b', 'j', 'e', 'c', 't'):
          return kHtmlTagObject;
        case C6('o', 'p', 't', 'i', 'o', 'n'):
          return kHtmlTagOption;
        case C6('s', 'c', 'r', 'i', 'p', 't'):
          return kHtmlTagScript;
        case C6('s', 'e', 'l', 'e', 'c', 't'):
          return kHtmlTagSelect;
        case C6('s', 't', 'r', 'i', 'k', 'e'):
          return kHtmlTagStrike;
        case C6('s', 't', 'r', 'o', 'n', 'g'):
          return kHtmlTagStrong;
        case C6('s', 'p', 'a', 'c', 'e', 'r'):
          return kHtmlTagSpacer;
        // From Netscape Navigator 4.0
        case C6('i', 'l', 'a', 'y', 'e', 'r'):
          return kHtmlTagIlayer;
        case C6('k', 'e', 'y', 'g', 'e', 'n'):
          return kHtmlTagKeygen;
        case C6('s', 'e', 'r', 'v', 'e', 'r'):
          return kHtmlTagServer;
        // New tags in HTML5.
        case C6('c', 'a', 'n', 'v', 'a', 's'):
          return kHtmlTagCanvas;
        case C6('f', 'i', 'g', 'u', 'r', 'e'):
          return kHtmlTagFigure;
        case C6('f', 'o', 'o', 't', 'e', 'r'):
          return kHtmlTagFooter;
        case C6('h', 'e', 'a', 'd', 'e', 'r'):
          return kHtmlTagHeader;
        case C6('h', 'g', 'r', 'o', 'u', 'p'):
          return kHtmlTagHgroup;
        case C6('o', 'u', 't', 'p', 'u', 't'):
          return kHtmlTagOutput;
        case C6('s', 'o', 'u', 'r', 'c', 'e'):
          return kHtmlTagSource;
      }
    } break;
    case 7: {
      switch (S7(tag) | case_mask_7_) {
        default:
          break;
        // From html 4.01 spec
        case C7('a', 'c', 'r', 'o', 'n', 'y', 'm'):
          return kHtmlTagAcronym;
        case C7('a', 'd', 'd', 'r', 'e', 's', 's'):
          return kHtmlTagAddress;
        case C7('c', 'a', 'p', 't', 'i', 'o', 'n'):
          return kHtmlTagCaption;
        case C7('i', 's', 'i', 'n', 'd', 'e', 'x'):
          return kHtmlTagIsindex;
        // Used in repository/parsers/base/handler-parser.cc
        case C7('m', 'a', 'r', 'q', 'u', 'e', 'e'):
          return kHtmlTagMarquee;
        case C7('b', 'g', 's', 'o', 'u', 'n', 'd'):
          return kHtmlTagBgsound;
        case C7('l', 'i', 's', 't', 'i', 'n', 'g'):
          return kHtmlTagListing;
        case C7('n', 'o', 'e', 'm', 'b', 'e', 'd'):
          return kHtmlTagNoembed;
        // From Netscape Navigator 4.0
        case C7('n', 'o', 'l', 'a', 'y', 'e', 'r'):
          return kHtmlTagNolayer;
        // Legacy tag used mostly by Russian sites
        case C7('n', 'o', 'i', 'n', 'd', 'e', 'x'):
          return kHtmlTagNoindex;
        // New tags in HTML5.
        case C7('a', 'r', 't', 'i', 'c', 'l', 'e'):
          return kHtmlTagArticle;
        case C7('c', 'o', 'm', 'm', 'a', 'n', 'd'):
          return kHtmlTagCommand;
        case C7('d', 'e', 't', 'a', 'i', 'l', 's'):
          return kHtmlTagDetails;
        case C7('s', 'e', 'c', 't', 'i', 'o', 'n'):
          return kHtmlTagSection;
        case C7('s', 'u', 'm', 'm', 'a', 'r', 'y'):
          return kHtmlTagSummary;
        // The HTML5 picture tag.
        case C7('p', 'i', 'c', 't', 'u', 'r', 'e'):
          return kHtmlTagPicture;
      }
    } break;
    case 8: {
      switch (S8(tag) | case_mask_8_) {
        default:
          break;
        // From html 4.01 spec
        case C8('b', 'a', 's', 'e', 'f', 'o', 'n', 't'):
          return kHtmlTagBasefont;
        case C8('c', 'o', 'l', 'g', 'r', 'o', 'u', 'p'):
          return kHtmlTagColgroup;
        case C8('f', 'i', 'e', 'l', 'd', 's', 'e', 't'):
          return kHtmlTagFieldset;
        case C8('f', 'r', 'a', 'm', 'e', 's', 'e', 't'):
          return kHtmlTagFrameset;
        case C8('n', 'o', 'f', 'r', 'a', 'm', 'e', 's'):
          return kHtmlTagNoframes;
        case C8('n', 'o', 's', 'c', 'r', 'i', 'p', 't'):
          return kHtmlTagNoscript;
        case C8('o', 'p', 't', 'g', 'r', 'o', 'u', 'p'):
          return kHtmlTagOptgroup;
        case C8('t', 'e', 'x', 't', 'a', 'r', 'e', 'a'):
          return kHtmlTagTextarea;
        // From Netscape Navigator 4.0
        case C8('m', 'u', 'l', 't', 'i', 'c', 'o', 'l'):
          return kHtmlTagMulticol;
        // New tags in HTML5.
        case C8('d', 'a', 't', 'a', 'l', 'i', 's', 't'):
          return kHtmlTagDatalist;
        case C8('p', 'r', 'o', 'g', 'r', 'e', 's', 's'):
          return kHtmlTagProgress;
        // Other HTML5 tags.
        case C8('t', 'e', 'm', 'p', 'l', 'a', 't', 'e'):
          return kHtmlTagTemplate;
      }
    } break;
    case 9: {
  ...
  if (S1(tag) == C1('!') || S1(tag) == C1('?')) return kHtmlTagBogusComment;
